{
  ...
  wadDirectory = pkgs.freedoom;
in {
  xdg.configFile."gzdoom/gzdoom.ini".text = lib.mkIf (lib.elem "gaming" config.device.tags) ''
    # This file was generated by GZDoom g4.14.0 on 2025-01-25 22:16:55
    ...
    Path=/usr/local/share//doom
    Path=/usr/local/share//games/doom
    Path=/nix/store/mlg1zxy3dprvr0qf1ll477mamjl0wd3l-freedoom-0.13.0
    Path=/run/media/binette/sdcard/Games/SteamLibrary/steamapps/common/Ultimate Doom/base
    Path=/run/media/binette/sdcard/Games/SteamLibrary/steamapps/common/Ultimate Doom/base/doom2
    Path=/run/media/binette/sdcard/Games/SteamLibrary/steamapps/common/Ultimate Doom/base/plutonia
    Path=/run/media/binette/sdcard/Games/SteamLibrary/steamapps/common/Ultimate Doom/base/tnt
    ...
    [Doom.AutoExec]
    Path=/home/binette/.config/gzdoom/autoexec.cfg
    ...
    cl_restartondeath=false
    cl_rubberband_limit=756
    cl_rubberband_minmove=20
    cl_rubberband_scale=0.3
    cl_rubberband_threshold=20
    cl_run=false
    cl_scaleweaponfov=1
    cl_waitforsave=true
    con_4bitansi=false
    ...
    m_forward=1
    m_pitch=1
    m_sensitivity_x=1.01344
    m_sensitivity_y=1.03813
    m_show_backbutton=0
    m_showinputgrid=0
    m_side=2
    ...
    r_skymode=2
    r_spriteclipanamorphicminbias=0.6
    r_vanillatrans=0
    ...
    forcewater=false
    maxviewpitch=90
    r_dithertransparency=false
    r_radarclipper=false
