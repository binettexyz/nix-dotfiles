                    ...
                    items = [
                      {
                        ...
                        url = "http://radarr.${baseDomain}";
                      }
                      {
                        name = "Sonarr";
                        logo = logoDir + "/sonarr.png";
                        url = "http://sonarr.${baseDomain}";
                      }
                      {
                        name = "Jellyfin";
                    ...
                    items = [
                      {
                        ...
                        url = "http://budget.${baseDomain}";
                      }
                      {
                        name = "Gitea";
                        logo = logoDir + "/gitea.png";
                        url = "http://git.${baseDomain}";
                      }
                      {
                        name = "Miniflux";
                        logo = logoDir + "/miniflux.png";
                        url = "http://feed.${baseDomain}";
                      }
                      {
                        name = "Nextcloud";
                        logo = logoDir + "/nextcloud.png";
                        url = "http://cloud.${baseDomain}";
                      }
                      {
                        name = "Vaultwarden";
                        logo = logoDir + "/bitwarden.png";
                        url = "http://vault.${baseDomain}";
                      }
                    ];
                  }
                    ...
                    items = [
                      {
                        ...
                        url = "http://jackett.${baseDomain}";
                      }
                      {
                        name = "AdGuardHome";
                        logo = logoDir + "/adguardhome.png";
                        url = "http://agh.${baseDomain}";
                      }
                    ];
                  }
